QUESTIONS_AND_ANSWERS = [
    ...
    # Добавьте остальные вопросы и ответы здесь
]

NAME = ['Молдир', 'Анар']
LAST_NAME = ['Бектенова','Казыбекова']
ADDRESS = ['Комарова, 15', 'Пушкина, 5']
STATION_NAME = ['Бульвар Рокоссовского', 'Черкизовская']
TELEPHONE_NUMBER = ['79857777777', '74855001166']
COMMENT = ['можете привезти вечером', 'приветприветпривет']